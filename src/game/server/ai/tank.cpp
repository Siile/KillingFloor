...
CAITank::CAITank(CGameContext *pGameServer, CPlayer *pPlayer)
...
void CAITank::OnCharacterSpawn(CCharacter *pChr)
{
	pChr->SetCustomWeapon(HAMMER_BOTBASIC);
	pChr->SetHealth(13+GameServer()->Difficulty()*3);
